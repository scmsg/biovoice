...
<body>
	...
	<form:form id="inputForm" modelAttribute="depatement" action="${ctx}/bv/depatement/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="deptName" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">负责人：</label>
			<div class="controls">
				<form:input path="deptHdea" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">联系电话：</label>
			<div class="controls">
				<form:input path="deadMobile" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
