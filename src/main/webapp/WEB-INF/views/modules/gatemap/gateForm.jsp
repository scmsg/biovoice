...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/gatemap/gate/">网关地图生成成功列表</a></li>
		<li class="active"><a href="${ctx}/gatemap/gate/form?id=${gate.id}">网关地图生成成功<shiro:hasPermission name="gatemap:gate:edit">${not empty gate.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gatemap:gate:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="gate" action="${ctx}/gatemap/gate/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="gatemap:gate:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
